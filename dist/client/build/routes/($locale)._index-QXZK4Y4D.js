...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1700975738774.8364";
}
function meta() {
  return [{
    title: "Hydrogen"
...
function Index() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "w-full gap-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid_default, { container: true, spacing: 2, children: [
      collection.products.nodes[0],
      collections.nodes.map((collection2) => {
        return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid_default, { md: 3, children: [
          collection2.products.nodes[0],
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/collections/${collection2.handle}`, children: [
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image, { alt: `Image of ${collection2.title}`, data: collection2.image, sizes: "(max-width: 32em) 100vw, 33vw", width: 128, height: 128, crop: "center" }, collection2.id, false, {
              fileName: "app/routes/($locale)._index.jsx",
              lineNumber: 53,
              columnNumber: 19
            }, this),
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "font-medium text-copy", children: collection2.title }, void 0, false, {
              fileName: "app/routes/($locale)._index.jsx",
              lineNumber: 54,
              columnNumber: 17
            }, this)
...
@mui/material/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/($locale)._index-QXZK4Y4D.js.map
