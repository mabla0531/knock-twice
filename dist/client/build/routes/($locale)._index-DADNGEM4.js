...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701062623956.3933";
}
function meta() {
  return [{
    title: "Hydrogen"
...
function Index() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "w-full gap-4", children: [
    ...
    collections.nodes.map((collection) => {
      return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/collections/${collection.handle}`, children: [
...
//# sourceMappingURL=/build/routes/($locale)._index-DADNGEM4.js.map
