...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1700975687447.8835";
}
function meta() {
  return [{
    title: "Hydrogen"
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "w-full gap-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid_default, { container: true, spacing: 2, children: collections.nodes.map((collection) => {
      return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid_default, { md: 3, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/collections/${collection.handle}`, children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image, { alt: `Image of ${collection.title}`, data: collection.products.nodes[0].variants[0], sizes: "(max-width: 32em) 100vw, 33vw", width: 128, height: 128, crop: "center" }, collection.id, false, {
          fileName: "app/routes/($locale)._index.jsx",
          lineNumber: 50,
          columnNumber: 19
        }, this),
...
@mui/material/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/($locale)._index-ZFZEFN5G.js.map
