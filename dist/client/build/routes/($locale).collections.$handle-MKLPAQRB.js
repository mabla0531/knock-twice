...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701060842764.5007";
}
var meta = ({
  data
}) => {
...
function Collection() {
  ...
  var currentProduct = (0, import_react2.useState)(0, setProduct);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "collection", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(rr, { connection: collection.products, children: ({
      nodes
    }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "products-grid", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ProductItem, { products: nodes, currentProduct: {
      currentProduct
    } }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 94,
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-MKLPAQRB.js.map
