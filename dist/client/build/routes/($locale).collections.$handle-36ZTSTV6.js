...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701025126496.8843";
}
var meta = ({
  data
}) => {
...
function Collection() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "collection", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(rr, { connection: collection.products, children: (nodes) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "products-grid", children: [
        "return ( asdfasdf",
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ProductItem, { product: nodes[currentProduct] }, nodes[currentProduct].id, false, {
          fileName: "app/routes/($locale).collections.$handle.jsx",
          lineNumber: 91,
          columnNumber: 17
        }, this),
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-36ZTSTV6.js.map
