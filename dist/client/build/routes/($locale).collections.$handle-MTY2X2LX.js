...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701063238676.291";
}
var meta = ({
  data
}) => {
...
function Collection() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "App", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: () => testFunction(), children: "test btn" }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 92,
      columnNumber: 9
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { children: count }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 93,
      columnNumber: 9
    }, this)
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-MTY2X2LX.js.map
