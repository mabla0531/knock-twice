...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701067107588.822";
}
var meta = ({
  data
}) => {
...
function ProductItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { className: "product-item", prefetch: "intent", to: variantUrl, children: [
    product.featuredImage && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { alt: product.featuredImage.altText || product.title, aspectRatio: "1/1", src: product.featuredImage, sizes: "(max-width: 32em) 100vw, 33vw", width: 128, height: 128, crop: "center" }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 130,
      columnNumber: 33
    }, this),
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-VB6BK2ND.js.map
