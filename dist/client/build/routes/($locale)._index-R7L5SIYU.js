...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1700957913927.98";
}
var meta = () => {
  return [{
    title: "Hydrogen | Home"
...
function Collections({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "collections", children: [
    ...
    }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "collections-grid", children: collections2.products.map((collection) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { className: "collection", to: `/collections/${collection.handle}`, children: [
...
//# sourceMappingURL=/build/routes/($locale)._index-R7L5SIYU.js.map
