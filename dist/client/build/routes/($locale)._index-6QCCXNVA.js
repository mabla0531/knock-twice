...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1700964664199.941";
}
function meta() {
  return [{
    title: "Hydrogen"
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "w-full gap-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid-flow-row grid gap-2 gap-y-6 md:gap-4 lg:gap-6", children: collections.nodes.map((collection) => {
      return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid_default, { md: 3, xs: 3, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/collections/${collection.handle}`, children: [
        collection?.image && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image, { alt: `Image of ${collection.title}`, data: collection.products.nodes[0].variants.nodes[0].image, sizes: "(max-width: 32em) 100vw, 33vw", width: 128, height: 128, crop: "center" }, collection.id, false, {
          fileName: "app/routes/($locale)._index.jsx",
          lineNumber: 51,
          columnNumber: 41
        }, this),
...
@mui/material/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/($locale)._index-6QCCXNVA.js.map
