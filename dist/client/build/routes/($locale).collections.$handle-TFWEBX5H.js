...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701025776929.839";
}
var meta = ({
  data
}) => {
...
function ProductsGrid({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "products-grid", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ProductItem, { products, currentProduct }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 117,
      columnNumber: 7
    }, this),
...
function ProductItem({
  ...
  _s2();
  const variant = products.nodes[currentProduct].variants.nodes[0];
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-TFWEBX5H.js.map
