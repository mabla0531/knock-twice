...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701064345579.6975";
}
var meta = ({
  data
}) => {
...
function ProductItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { className: "product-item", prefetch: "intent", to: variantUrl, children: [
    product.featuredImage && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image, { alt: product.featuredImage.altText || product.title, aspectRatio: "1/1", data: product.featuredImage, sizes: "(min-width: 45em) 128px, 100vw", width: 128, height: 128 }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 130,
      columnNumber: 33
    }, this),
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-7LGARCLO.js.map
