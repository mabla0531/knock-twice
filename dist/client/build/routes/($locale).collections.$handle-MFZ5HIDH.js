...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701640908279.3008";
}
var meta = ({
  data
}) => {
...
function Collection() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "collection", style: {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: {
      ...
      nodes
    }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ProductItem, { product: nodes[currentProduct], style: {
      display: "flex",
      justifyContent: "center",
      alignItems: "center"
    } }, void 0, false, {
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-MFZ5HIDH.js.map
