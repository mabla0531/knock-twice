...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1700966057870.5962";
}
function meta() {
  return [{
    title: "Hydrogen"
...
function Index() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "w-full gap-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "gap-2 gap-y-6 md:gap-4 lg:gap-6", children: collections.nodes.map((collection) => {
...
@mui/material/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/($locale)._index-QMKZSV3U.js.map
