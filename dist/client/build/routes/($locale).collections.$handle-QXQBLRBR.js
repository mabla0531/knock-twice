...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701659647697.9116";
}
var meta = ({
  data
}) => {
...
function ProductItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: {
    ...
    display: "block"
  }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { prefetch: "intent", to: variantUrl, children: product2.featuredImage && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: {
    display: "flex",
    justifyContent: "center",
    alignItems: "center"
  }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image, { alt: product2.featuredImage.altText || product2.title, aspectRatio: "1/1", data: product2.featuredImage, width: 256, style: {
    display: "block"
  } }, void 0, false, {
    fileName: "app/routes/($locale).collections.$handle.jsx",
    lineNumber: 185,
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-QXQBLRBR.js.map
