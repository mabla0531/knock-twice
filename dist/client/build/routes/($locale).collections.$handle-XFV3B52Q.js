...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701070850817.2107";
}
var meta = ({
  data
}) => {
...
function ProductItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { className: "product-item", prefetch: "intent", to: variantUrl, children: [
    product.featuredImage && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("img", { aspectRatio: "1/1", src: product.featuredImage.url, width: "100px" }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 129,
      columnNumber: 33
    }, this),
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-XFV3B52Q.js.map
