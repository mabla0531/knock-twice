...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701037370492.402";
}
var meta = ({
  data
}) => {
...
function Collection() {
  ...
  const productIndex = (0, import_react.useState)(0);
  const variant2 = product.variants.nodes[0];
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "collection", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(rr, { connection: collection.products, children: ({
      nodes
    }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "products-grid", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ProductItem, { products: nodes }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 93,
      columnNumber: 13
    }, this) }, void 0, false, {
...
_s(Collection, "Vsj566tU1aamVIfqn1+qOHjRaqI=", false, function() {
  return [useLoaderData];
});
_c = Collection;
function ProductItem(product2) {
  _s2();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { className: "product-item", prefetch: "intent", to: variantUrl, children: [
    product2.featuredImage && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image, { alt: product2.featuredImage.altText || product2.title, aspectRatio: "1/1", data: product2.featuredImage, sizes: "(min-width: 45em) 400px, 100vw" }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 113,
      columnNumber: 33
    }, this),
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-MGDPGXRH.js.map
