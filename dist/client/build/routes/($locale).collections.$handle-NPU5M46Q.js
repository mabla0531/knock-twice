...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701638318994.2256";
}
var meta = ({
  data
}) => {
  return [{
    title: `KT | ${data?.collection.title ?? ""} Collection`
  }];
};
function Collection() {
  _s();
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-NPU5M46Q.js.map
