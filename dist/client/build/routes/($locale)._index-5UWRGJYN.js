...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1700960762060.718";
}
function meta() {
  return [{
    title: "Hydrogen"
...
function Index() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("section", { className: "w-full gap-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid-flow-row grid gap-2 gap-y-6 md:gap-4 lg:gap-6 grid-cols-1 sm:grid-cols-3", children: collections.nodes.map((collection) => {
      return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Grid_default, { xs: 3, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: `/collections/${collection.handle}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid gap-4", children: [
...
@mui/material/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/($locale)._index-5UWRGJYN.js.map
