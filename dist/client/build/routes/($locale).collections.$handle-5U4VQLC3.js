...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701028044901.6917";
}
var meta = ({
  data
}) => {
...
function Collection() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "collection", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(rr, { connection: collection.products, children: ({
      ...
      PreviousLink,
      NextLink
    }) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "products-grid", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ProductItem, { products, currentProduct }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 92,
      columnNumber: 13
    }, this) }, void 0, false, {
...
function ProductItem({
  ...
  _s2();
  const product = products2[currentProduct2];
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-5U4VQLC3.js.map
