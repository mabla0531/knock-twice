...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701064954836.8474";
}
var meta = ({
  data
}) => {
...
function ProductItem({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { className: "product-item", prefetch: "intent", to: variantUrl, children: [
    product.featuredImage && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Image, { alt: product.featuredImage.altText || product.title, aspectRatio: "1/1", data: product.featuredImage, sizes: "128px", width: 128, height: 128 }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 130,
      columnNumber: 33
    }, this),
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-HQKH5LUI.js.map
