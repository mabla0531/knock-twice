...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701037389730.086";
}
var meta = ({
  data
}) => {
...
function Collection() {
  ...
  const variantUrl2 = useVariantUrl(product.handle, variant.selectedOptions);
...
_s(Collection, "ZtBjz4Z2AP2YSoBc6Gx0/1gWWtY=", false, function() {
  return [useLoaderData, useVariantUrl];
});
_c = Collection;
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-YNORE7TD.js.map
