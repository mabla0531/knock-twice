...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701064004362.1794";
}
var meta = ({
  data
}) => {
...
function Collection() {
  ...
  const incrementProduct = () => {
    if (currentProduct < collection.products.nodes.length) {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "collection", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: () => decrementProduct(), children: "Previous Button" }, void 0, false, {
      fileName: "app/routes/($locale).collections.$handle.jsx",
      lineNumber: 97,
      columnNumber: 7
    }, this),
...
//# sourceMappingURL=/build/routes/($locale).collections.$handle-2JMZAZVN.js.map
